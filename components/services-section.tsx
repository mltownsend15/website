    ...
    <section className="py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Our Service Offerings Include:</h2>
          <p className="text-lg text-gray-600 mb-8">
            Specialized mental health services for ages {siteConfig.eligibility.ageRange}
          </p>
        </div>
            ...
            return (
              <Card key={index} className="hover:shadow-lg transition-shadow">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-600 text-sm leading-relaxed mb-4 text-center">{service.description}</p>
