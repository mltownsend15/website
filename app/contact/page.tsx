...
import { MapPin, Phone, VoicemailIcon as Fax, Mail, Clock, MessageSquare } from "lucide-react"
      ...
      <div className="py-16 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">Contact Miranda for a Free Consultation</h1>
          </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-start space-x-4 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 mb-1">{siteConfig.contact.note}</p>
                  ...
                  <div className="flex items-start space-x-4 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">{siteConfig.contact.fax}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    <MessageSquare className="w-6 h-6 text-emerald-300 mt-1" />
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-2">Booking Policy</h3>
                      <p className="text-gray-600 text-sm">{siteConfig.contact.bookingNote}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <div className="space-y-4">
                    <Button size="lg" className="w-full bg-emerald-300 hover:bg-emerald-400 text-white" asChild>
                      <a
