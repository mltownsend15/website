            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card>
                <CardHeader>
                  ...
                  <CardTitle className="text-xl">Step 1: New Clients</CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardTitle className="text-xl">Step 2: Insured Clients</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-600 mb-4">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardTitle className="text-xl">Step 3: Cash Pay Clients</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-600 mb-4">
            ...
            <CardContent className="p-8">
              <div className="md:flex items-center">
                ...
                <div className="md:w-2/3 md:pl-8">
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">What is Medication Management?</h3>
                  <p className="text-gray-600 leading-relaxed">
                    Psychiatric medication management is the process of evaluating and treating mental health conditions
                    with the use of medication. The act of prescribing medications is thought of as a practice or an
                    art. During our appointments we will explore symptoms through talking or filling out rating scales.
                    We identify clusters of symptoms and categorize them into diagnoses. Then we target those diagnoses
                    with interventions like medication(s) and counseling. The first meeting is an hour long but follow
                    up appointments are 30 minutes- an hour. People can use this service briefly, for a few months or
                    long term, for a few years. We may meet as frequently as weekly or as infrequently as the minimum
                    requirement of meeting every three months. Meeting every three months ensures that your care is as
          ...
          <Card className="bg-red-50 border-red-200">
            ...
            <CardContent>
              <ul className="text-red-700 space-y-2">
                <li>
                  1. It is beyond the scope of my practice to consult, provide expert witness, or to participate in
                  placement decisions of a youth in legal proceedings such as in the case of divorce.
                </li>
                <li>2. Therapy without medication management.</li>
