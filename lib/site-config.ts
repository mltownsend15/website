export const siteConfig = {
  ...
  tagline: "Compassionate, inclusive, and professional care prioritized through your mental health and well-being",
  description:
  ...
  contact: {
    ...
    hours: ["Tuesday: 8 AM - 11 AM", "Wednesday: 8 AM - 4 PM", "Thursday: 8 AM - 4 PM"],
  ...
  services: [
    ...
    },
    {
      ...
      subtitle: "Youth centered psychiatric medication management and counseling",
      description: "Youth-centered psychiatric medication management combined with therapeutic counseling support.",
      duration: "30 min",
      price: "150",
      type: "Virtual",
      icon: "pill",
  ...
  whyChoose: {
    ...
    subtitle: "We offer an experienced and proven approach to help patients get better and stay better!",
    points: [
      {
        title: "Personalized",
        description:
          "At Townsend Medical Services, we spend significantly more time with each patient than the average clinic to provide truly individualized care.",
      },
      {
        title: "Specialized",
        description:
